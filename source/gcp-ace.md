10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
=XAMTOPICS
...
B. Ask each member of the team to generate a new SSH key pair and to send you their public key. Use a configuration management tool to
...
A€compute.osAdminLogina€ role to the Google group corresponding to this team.
D. Generate a new SSH key pair. Give the private key to each member of your team. Configure the public key as a project-wide public SSH key
...
Community vote distribution
B (94%) 6%
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ v8s
...
A. Create an HTTP load balancer with a backend configuration that references an existing instance group. Set the health check to healthy
(HTTP)
B. Create an HTTP load balancer with a backend configuration that references an existing instance group. Define a balancing mode and set
...
Community vote distribution
C (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 285
...
Correct Answer: D
Reference:
https://medium.com/google-cloud/kubernetes-engine-kubectl-config-b6270d2b656¢
Community vote distribution
D (100%)
Question #6 Topic 1
...
Community vote distribution
D (64%) C (36%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 3/85
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ /85
...
C. Create a docker image from the Dockerfile and upload it to Container Registry. Create a Deployment YAML file to point to that image. Use
kubectl to create the deployment with that file.
D. Create a docker image from the Dockerfile and upload it to Cloud Storage. Create a Deployment YAML file to point to that image. Use
kubectl to create the deployment with that file.
Correct Answer: C
Reference -
...
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 5/85
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 6/85
...
action to 90 days and the Delete action to 275 days (365 90 "€a)
...
A. When creating the VM via the web console, specify the service account under the ‘ldentity and API Access' section.
...
Community vote distribution
A (80%) C (20%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 7185
...
instance.
C. Set a Windows password in the GCP Console. Verify that a firewall rule for port 22 exists. Click the RDP button in the GCP Console and
supply the credentials to log in.
D. Set a Windows username and password in the GCP Console. Verify that a firewall rule for port 3389 exists. Click the RDP button in the GCP
...
A. Create two configurations using gcloud config configurations create [NAME]. Run gcloud config configurations activate [NAME] to switch
between accounts when running the commands to start the Compute Engine instances.
B. Create two configurations using gcloud config configurations create [NAME]. Run gcloud configurations list to start the Compute Engine
instances.
C. Activate two configurations using gcloud configurations activate [NAME]. Run gcloud config list to start the Compute Engine instances.
D. Activate two configurations using gcloud configurations activate [NAME]. Run gcloud configurations list to start the Compute Engine
instances.
Correct Answer: A
Community vote distribution
A (89%) 11%
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 8/85
...
D. Execute the Deployment Manager template using the A€"-preview option in the same project, and observe the state of interdependent
resources.
Correct Answer: D
Reference:
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 10/85
...
B. Add the auditors group to two new custom |AM roles.
C. Add the auditor user accounts to the 'logging.viewer' and 'bigQuery.dataViewer' predefined |AM roles.
...
D. Create a service account and add it to the |AM role 'storage.objectAdmin’ for that bucket.
Correct Answer: D
Community vote distribution
C (100%)
Question #27 Topic 1
...
Community vote distribution
A (64%) B (36%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/
...
follow Google- recommended practices. Which |AM roles should you grant your colleagues?
A. Project Editor
B. Storage Admin
...
C. Configure the storage bucket as a static website and furnish the object's URL to the company. Delete the object from the storage bucket
after four hours.
D. Create a new Cloud Storage bucket specifically for the external company to access. Copy the object to that bucket. Delete the bucket after
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 12/85
...
D. Grant the App Engine Default service account the role of Cloud Pub/Sub Admin. Have your application enable the API on the first
...
D. Configure a single Stackdriver account for one oft he projects. In Stackdriver, create a Group and add the other project names as criteria for
that Group.
Correct Answer: D
Community vote distribution
C (79%) D (21%)
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 13/85
...
Community vote distribution
C (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 14/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #37 Topic 1
You created a Google Cloud Platform project with an App Engine application inside the project. You initially configured the application to be served
from the us- central region. Now you want the application to be served from the asia-northeast1 region. What should you do?
...
D. Select A€Container-Optimized 0S (cos)a€ as a node image for your GKE cluster.
Correct Answer: B
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 15/85
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 16/85
...
containers:
- name: main-container
image: gcr.io/my-company-repo/myappl:1.4
env:
- name: DB_PASSWORD
value: "tOugh2guess!”
ports:
...
B. Store the database password inside a Secret object. Modify the YAML file to populate the DB_PASSWORD environment variable from the
Secret.
C. Store the database password inside a ConfigMap object. Modify the YAML file to populate the DB_PASSWORD environment variable from
the ConfigMap.
D. Store the database password in a file inside a Kubernetes persistent volume, and use a persistent volume claim to mount the volume to the
container.
Correct Answer: C
Community vote distribution
B (100%)
...
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 17/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #44 Topic 1
You need to select and configure compute resources for a set of batch processing jobs. These jobs take around 2 hours to complete and are run
...
C. On the App Engine Versions page of the GCP Console, route 100% oft he traffic to the previous version.
D. Deploy the original version as a separate application. Then go to App Engine settings and split traffic between applications so that the
...
C (100%)
Question #46 Topic 1
You deployed an App Engine application using gcloud app deploy, but it did not deploy to the intended project. You want to find out why this
...
Community vote distribution
D (80%) A (20%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 18/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #47 Topic 1
You want to configure 10 Compute Engine instances for availability when maintenance occurs. Your requirements state that these instances
...
A (100%)
Question #48 Topic 1
You host a static website on Cloud Storage. Recently, you began to include links to PDF files on this site. Currently, when users click on the links to
...
C (100%)
Question #49 Topic 1
You have a virtual machine that is currently configured with 2 vCPUs and 4 GB of memory. It is running out of memory. You want to upgrade the
...
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 19/85
...
Community vote distribution
A (79%) C (21%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 20/85
...
A. 1. Create an |AM entry for each data scientist's user account. 2. Assign the BigQuery jobUser role to the group.
...
Community vote distribution
C (65%) D (35%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 2185
...
What should you do?
A. 1. Create an ingress firewall rule with the following settings: A€¢ Targets: all instances A€¢ Source filter: IP ranges (with the range set to
10.0.2.0/24) A€¢ Protocols: allow all 2. Create an ingress firewall rule with the following settings: A€¢ Targets: all instances a€¢ Source filter:
IP ranges (with the range set to 10.0.1.0/24) a€¢ Protocols: allow all
B. 1. Create an ingress firewall rule with the following settings: A€¢ Targets: all instances with tier #2 service account A€¢ Source filter: all
instances with tier #1 service account A€¢ Protocols: allow TCP:8080 2. Create an ingress firewall rule with the following settings: A€¢
Targets: all instances with tier #3 service account A€¢ Source filter: all instances with tier #2 service account A€¢ Protocols: allow TCP: 8080
C. 1. Create an ingress firewall rule with the following settings: A€¢ Targets: all instances with tier #2 service account A€¢ Source filter: all
instances with tier #1 service account A€¢ Protocols: allow all 2. Create an ingress firewall rule with the following settings: A€¢ Targets: all
instances with tier #3 service account A€¢ Source filter: all instances with tier #2 service account A€¢ Protocols: allow all
D. 1. Create an egress firewall rule with the following settings: A€¢ Targets: all instances A€¢ Source filter: IP ranges (with the range set to
10.0.2.0/24) A€¢ Protocols: allow TCP: 8080 2. Create an egress firewall rule with the following settings: A€¢ Targets: all instances A€¢ Source
filter: IP ranges (with the range set to 10.0.1.0/24) a€¢ Protocols: allow TCP: 8080
Correct Answer: B
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 22/85
...
A. 1. Create a subnetwork in the same VPC, in europe-west1. 2. Create the new instance in the new subnetwork and use the first instance's
...
D. 1. Create a VPC and a subnetwork in europe-west1. 2. Peer the 2 VPCs. 3. Create the new instance in the new subnetwork and use the first
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 23/85
...
D. Create a new App Engine application in the same project. Deploy the new version in that application. Configure your network load balancer
to send 1% of the traffic to that new application.
Correct Answer: B
Community vote distribution
B (100%)
Question #57 Topic 1
...
should you do?
A. Perform arolling-action start-update with maxSurge set to 0 and maxUnavailable setto 1.
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 24/85
...
Community vote distribution
C (54%) A (45%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 25/85
...
A. 1. In GKE, create a Service of type LoadBalancer that uses the application's Pods as backend. 2. Set the service's externalTrafficPolicy to
Cluster. 3. Configure the Compute Engine instance to use the address oft he load balancer that has been created.
...
Community vote distribution
Question #61 Topic 1
Your organization is a financial company that needs to store audit log files for 3 years. Your organization has hundreds of Google Cloud projects.
You need to implement a cost-effective approach for log file retention. What should you do?
...
Community vote distribution
B (91%) 9%
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 26/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #62 Topic 1
You want to run a single caching HTTP reverse proxy on GCP for a latency-sensitive website. This specific reverse proxy consumes almost no
...
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 27/85
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 28/85
...
B. Configure the acquired company's billing account and your company's billing account to export the billing data into the same BigQuery
dataset.
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 29/85
...
C. 1. In Cloud Logging, create a filter to view only Compute Engine logs. 2. Click Create Export. 3. Choose BigQuery as Sink Service, and the
platform-logs dataset as Sink Destination.
D. 1. Create a Cloud Function that has the BigQuery User role on the platform-logs dataset. 2. Configure this Cloud Function to create a
...
A. Add the cluster's AP as a new Type Provider in Deployment Manager, and use the new type to create the DaemonSet.
B. Use the Deployment Manager Runtime Configurator to create a new Config resource that contains the DaemonSet definition.
C. With Deployment Manager, create a Compute Engine instance with a startup script that uses kubectl to create the DaemonSet.
D. Inthe cluster's definition in Deployment Manager, add a metadata that has kube-system as key and the DaemonSet manifest as value.
Correct Answer: C
Reference:
https://cloud.google.com/kubernetes-engine/docs/how-to/cluster-access-for-kubectl
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 3085
...
Community vote distribution
A (83%) R (17%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 3185

Associate Cloud Engineer Exam —Free Actual Q&As, Page 1| ExamTopics
10/9/22, 7:19 PM
Question #72  Topic 1
You deployed a new application inside your Google Kubernetes Engine cluster using the YAML file specified below.
| apiVersion:              | apps/vl  | apiVersion:          | vl  |     |     |
| ------------------------ | -------- | -------------------- | --- | --- | --- |
...
| ----------------------------------- | --- | ------ | -------- | -------- | ---- |
| myapp-deployment-58ddbbb995-1p86ém  |     | 0/1    | Pending  | 0        | Sm   |
| myapp-deployment-58ddbbb995-qjpkg   |     | 1/1    | Running  | 0        | Sm   |
You want to find out why the pod is stuck in pending status. What should you do?
A. Review details of the myapp-service Service object and check for error messages.
B. Review details of the myapp-deployment Deployment object and check for error messages.
C. Review details of myapp-deployment-58ddbbb995-Ip86m Pod and check for warmning messages.
D. View logs of the container in myapp-deployment-58ddbbb995-Ip86m pod and check for warning messages.
Correct Answer: C
Reference:
...
|     | C (75%)  | B( 25%)  |     |     |     |
| --- | -------- | -------- | --- | --- | --- |
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/  32/185
...
JSON file to log in to the VM.
Correct Answer: D
Community vote distribution
B (100%)
Question #74 Topic 1
You want to configure an SSH connection to a single Compute Engine instance for users in the dev1 group. This instance is the only resource in
this particular
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 33/85
...
D. Deploy a new version of your application in App Engine. Then go to App Engine settings in GCP Console and split traffic between the current
version and newly deployed versions accordingly.
Correct Answer: D
Community vote distribution
D (100%)
Question #77 Topic 1
You need to provide a cost estimate for a Kubernetes cluster using the GCP pricing calculator for Kubernetes. Your workload requires high I0Ps,
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 34/85
...
Balancer.
B. Create a Kubernetes Service of type ClusterIP for your application. Configure the public DNS name of your application using the IP of this
Service.
C. Create a Kubernetes Service of type NodePort to expose the application on port 443 of each node of the Kubernetes cluster. Configure the
public DNS name of your application with the IP of every node of the cluster to achieve load-balancing.
D. Create a HAProxy pod in the cluster to load-balance the traffic to all the pods of the application. Forward the public traffic to HAProxy with
an iptable rule. Configure the DNS name of your application using the public IP of the node HAProxy is running on.
Correct Answer: A
Reference:
...
A (100%)
Question #79 Topic 1
You need to enable traffic between multiple groups of Compute Engine instances that are currently running two different GCP projects. Each group
of Compute
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 35/85
...
A. Ask your ML team to add the A€accelerator: gpua€ annotation to their pod specification.
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 36/85
...
accounts.
D. Inthe G Suite console, add the users to a special group called cloud-console-users@yourdomain.com. Rely on the default behavior of the
Cloud Platform to grant users access if they are members oft his group.
Correct Answer: B
Reference:
...
A. Create two configurations using gcloud config. Write a script that sets configurations as active, individually. For each configuration, use
gcloud compute instances list to get a list of compute resources.
B. Create two configurations using gsutil config. Write a script that sets configurations as active, individually. For each configuration, use
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 37/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #85 Topic 1
You have a large 5-TB AVRO file stored in a Cloud Storage bucket. Your analysts are proficient only in SQL and need access to the data stored in
...
request.
D. Create a Hadoop cluster and copy the AVRO file to NDFS by compressing it. Load the file in a hive table and provide access to your analysts
...
D. Add a network tag of your choice to the instance running the LDAP server. Create a firewall rule to allow egress on UDP port 636 for that
network tag.
Correct Answer: C
Community vote distribution
C (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 38/85
...
A(91%) 9%
Question #90 Topic 1
You want to configure a solution for archiving data in a Cloud Storage bucket. The solution must be cost-effective. Data with multiple versions
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 30/85
...
C. Create bastion hosts both in your on-premises environment and on Google Cloud. Configure both as proxy servers using their public IP
addresses.
...
D (100%)
Question #92 Topic 1
You want to select and configure a solution for storing and archiving data on Google Cloud Platform. You need to support compliance objectives
...
across hundreds of projects. Your ClIO wants you to examine all datasets to find tables that contain an employee_ssn column. You want to
minimize effort in performing this task.
What should you do?
A. Go to Data Catalog and search for employee_ssn in the search box.
B. Write a shell script that uses the bq command line tool to loop through all the projects in your organization.
C. Write a script that loops through all the projects in your organization and runs a query on INFORMATION_SCHEMA.COLUMNS view to find
the employee_ssn column.
D. Write a Cloud Dataflow job that loops through all the projects in your organization and runs a query on INFORMATION_SCHEMA.COLUMNS
view to find employee_ssn column.
Correct Answer: D
Community vote distribution
A (10
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 40/85
...
$ kubectl get pods -1 app=myapp
NAME READY STATUS RESTART AGE
myapp-deployment-58ddbbb995-1p86m 0/1 Pending 0 Sm
myapp-deployment-58ddbbb995-qjpkg 1/1 Running 0 Sm
What is the most likely cause?
A. The pending Pod's resource requests are too large to fit on a single node of the cluster.
B. Too many Pods are already running in the cluster, and there are not enough resources left to schedule the pending Pod.
C. The node pool is configured with a service account that does not have permission to pull the container image used by the pending Pod.
D. The pending Pod was originally scheduled on a node that has been preempted between the creation of the Deployment and your verification
of the Pods' status. It is currently being rescheduled on a new node.
Correct Answer: B
Community vote distribution
B (61%) D (39%)
Question #95 Topic 1
You want to find out when users were added to Cloud Spanner Identity Access Management (IAM) roles on your Google Cloud Platform (GCP)
...
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 4185
...
However, you notice that query costs for BigQuery are very high, and you need to control costs. Which two methods should you use? (Choose two.)
...
C. Create a GKE node pool with a sandbox type configured to gvisor. Add the parameter runtimeClassName: gvisor to the specification of your
customers' Pods.
...
Community vote distribution
C (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 42185
...
ON Persons (
person_id,
D. Create a secondary index using the following Data Definition Language (DDL): Cirstonams,
lastname
) STORING (
profile picture
)
...
D (75%) C (25%)
Question #99 Topic 1
Your finance team wants to view the billing report for your projects. You want to make sure that the finance team does not get additional
...
Community vote distribution
C (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 43/85
...
Community vote distribution
D (67%) A (33%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 44/85
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 45/85
...
Correct Answer: A
Nearline, Coldline, and Archive offer ultra low-cost, highly-durable, highly available archival storage. For data accessed less than once a year,
Archive is a cost- effective storage option for long-term preservation of data. Coldline is also ideal for cold storagea€"data your business
expects to touch less than once a quarter.
For warmer storage, choose Nearline: data you expect to access less than once a month, but possibly multiple times throughout the year. All
storage classes are available across all GCP regions and provide unparalleled sub-second access speeds with a consistent API.
Reference:
https://cloud.google.com/storage/archival
Community vote distribution
A (54%) B (46%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 46/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #108 Topic 1
Ateam of data scientists infrequently needs to use a Google Kubernetes Engine (GKE) cluster that you manage. They require GPUs for some long-
...
Your organization has user identities in Active Directory. Your organization wants to use Active Directory as their source oft ruth for identities.
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 47185
...
Your management has asked an external auditor to review all the resources in a specific project. The security team has enabled the Organization
Policy called
...
Community vote distribution
C (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 48/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #112 Topic 1
You have a workload running on Compute Engine that is critical to your business. You want to ensure that the data on the boot disk oft his
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 49/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #115 Topic 1
You need to reduce GCP service costs for a division of your company using the fewest possible steps. You need to turn off all configured services
in an existing
...
B. 1. Verify that you are assigned the Project Owners IAM role for this project. 2. Switch to the project in the GCP console, locate the resources
and delete them.
...
A. Give a€project ownera€ for web-applications appropriate roles to crm-databases-proj.
B. Give A€project ownera£ role to crm-databases-proj and the web-applications project.
C. Give a€project ownera€ role to crm-databases-proj and bigquery.dataViewer role to web-applications.
...
Community vote distribution
D (62%) C (38%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 50/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #117 Topic 1
An employee was terminated, but their access to Google Cloud was not removed until 2 weeks later. You need to find out if this employee
...
clearly share with your organization the status of the custom role. This will be the first version of the custom role. What should you do?
...
Your company has a large quantity of unstructured data in different file formats. You want to perform ETL transformations on the data. You need
to make the data accessible on Google Cloud so it can be processed by a Dataflow job. What should you do?
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 51/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #120
You need to manage multiple Google Cloud projects in the fewest steps possible. You want to configure the Google Cloud SDK command line
interface (CLI) so that you can easily manage multiple projects. What should you do?
A. 1. Create a configuration for each project you need to manage. 2. Activate the appropriate configuration when you work with each of your
assigned Google Cloud projects.
B. 1. Create a configuration for each project you need to manage. 2. Use gcloud init to update the configuration values when you need to work
with a non-default project
C. 1. Use the default configuration for one project you need to manage. 2. Activate the appropriate configuration when you work with each of
your assigned Google Cloud projects.
D. 1. Use the default configuration for one project you need to manage. 2. Use gcloud init to update the configuration values when you need to
...
Community vote distribution
A (73%) C (27%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 52/85
...
Alerting Policy that uses the threshold as a trigger condition. 3. Configure your email address in the notification channel.
...
Cloud Monitoring, create an Alerting Policy based on this metric. 3. Configure your email address in the notification channel.
Correct Answer: D
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 53/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #124 Topic 1
You have an application that uses Cloud Spanner as a backend database. The application has a very predictable traffic pattern. You want to
...
B. Create a Cloud Monitoring alerting policy to send an alert to oncall SRE emails when Cloud Spanner CPU exceeds the threshold. SREs would
...
Your company publishes large files on an Apache web server that runs on a Compute Engine instance. The Apache web server is not the only
...
What should you do?
A. Set up a budget alert on the project with an amount of 100 dollars, a threshold of 100%, and notification type of A€email.A€
B. Set up a budget alert on the billing account with an amount of 100 dollars, a threshold of 100%, and notification type of A€email.A€
...
Community vote distribution
C (78%) 11% 11%
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 54/85
...
You have an application that receives SSL-encrypted TCP traffic on port 443. Clients for this application are located all over the world. You want to
...
Community vote distribution
C (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 55/85
...
Community vote distribution
A (52%) C (48%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 56/85
...
Correct Answer: B
The Owner, Editor, and Viewer primitive roles include the BigQuery Admin (roles/bigquery.dataOwner), BigQuery Data Editor
(roles/bigquery.dataEditor), and
BigQuery Data Viewer (roles/bigquery.dataViewer) roles, respectively. This means the Owner, Editor, and Viewer primitive roles have BigQuery
access as defined for the respective BigQuery roles.
Reference:
https://cloud.google.com/bigquery/docs/access-control
Community vote distribution
B (57%) A (43%)
Question #131 Topic 1
You need to create a copy of a custom Compute Engine virtual machine (VM) to facilitate an expected increase in application traffic due to a
...
Community vote distribution
B (73%) D (27%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 57/85
...
only in the project corp-aggregate-reports and needs a copy oft he daily exports in the bucket corp-aggregate-reports-storage. You want to
...
D. Make corp-aggregate-reports-storage public and create a folder with a pseudo-randomized suffix name. Share the folder with the loT team.
Correct Answer: A
Reference:
https://cloud.google.com/billing/docs/onboarding-checklist
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 58/85
...
C. Store credentials for service accounts with appropriate access for Google services in a config file, and deploy this config file with your
application.
D. Store credentials for your user account with appropriate access for Google services in a config file, and deploy this config file with your
application.
Correct Answer: B
Reference:
https://cloud.google.com/compute/docs/access/create-enable-service-accounts-for-instances
...
project.
B. Enable the Compute Engine API in the Cloud Console, use the Cloud SDK to create the instance, and then use the —project flag to specify a
new project.
C. Using the Cloud SDK, create the new instance, and use the —project flag to specify the new project. Answer yes when prompted by Cloud
SDK to enable the Compute Engine API.
D. Enable the Compute Engine APl in the Cloud Console. Go to the Compute Engine section of the Console to create a new instance, and look
for the Create In A New Project option in the creation form.
Correct Answer: B
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 59/85
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 60/85
...
B. In the Settings page for Compute Engine under Default location, set the zone to europea€"west1-d.
C. In the CLI installation directory, create a file called default.conf containing zone=europea€"west1a€'d.
D. Create a Metadata entry on the Compute Engine page with key compute/zone and value europea€"west1a€"d.
Correct Answer: C
Reference:
...
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 61/85
...
Correct Answer: B
Get private access to Google services, such as storage, big data, analytics, or machine learning, without having to give your service a public IP
address.
Reference:
https://cloud.google.com/vpc
Community vote distribution
A (83%) D (17%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 62/85
...
A. 1. Update your instances' metadata to add the following value: snapshota€"schedule: 0 1* * * 2. Update your instances' metadata to add
the following value: snapshota€"retention: 30
...
Create Schedule and configure the following parameters: - Schedule frequency: Daily - Start time: 1:00 AM 2:00 "€ AM - Autodelete snapshots
after: 30 days
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 63/85
...
B. Create a new Node Pool and specify machine type n2a€"highmem16"€a. Deploy the new pods.
C. Create a new cluster with n2a€"highmem16"€a nodes. Redeploy the pods and delete the old cluster.
D. Create a new cluster with both n1a€"standard2"€a and n2a€"highmem16"€a nodes. Redeploy the pods and delete the old cluster.
Correct Answer: B
Community vote distribution
B (100%)
...
A. A€" Create Compute Engine resources in usa€"central1a€"h. A€" Balance the load across both usa€'central1a€"a and usa€'central1a€"b.
B. A€" Create a Managed Instance Group and specify usa€"central1a€"a as the zone. A€" Configure the Health Check with a short Health
Interval.
C. A€" Create an HTTP(S) Load Balancer. a€" Create one or more global forwarding rules to direct traffic to your VMs.
D. A€" Perform regular backups of your application. A€" Create a Cloud Monitoring Alert and be notified if your application becomes
unavailable. A€" Restore from backups when notified.
Correct Answer: A
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 64/85
...
D. Use the command gcloud projects geta€"iama€"policy to view the current role assignments.
Correct Answer: A
Reference:
https://cloud.google.com/compute/docs/instances/adding-removing-ssh-keys
Community vote distribution
...
future jobs.
D. Run atest using N1 standard VMs instead of N2. If the test is successful, use N1 Standard VMs when running future jobs.
Correct Answer: B
Reference:
https://cloud.google.com/compute/vm-instance-pricing
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 65/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #151 Topic 1
You are working with a user to set up an application in a new VPC behind a firewall. The user is concerned about data egress. You want to
...
B. Tag all the instances with the same network tag. Create a firewall rule in the VPC to grant TCP access on port 22 for traffic from the
...
You have created a code snippet that should be triggered whenever a new file is uploaded to a Cloud Storage bucket. You want to deploy this code
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 66/85
...
id=q0nhDWAAQBAJ&pg=PA528&Ipg=PA52&dg=Set+up+a+policy+that+uses+Nearline+storage+for+30+days+and
+then+moves+to+Archivetstorage+fortthree
+years.&source=bl&ots=kYLZN1ymA8&sig=ACfU3U2XLmzQ39cmPDwjfWxRbNtDNLc_6g&hl=en&sa=X&ved=2ahUKEwjZmefOpr7qAhVzQkEAHTU
gASYQ6AE
wAHoECA0QAQ#v=onepage&q=Set%20up%20a%20policy%20that%20uses%20Nearline%20storage%20for%2030%20days %20and%20then%20m
oves%20to
...
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 67/85
...
A. Disable the flag A€Delete boot disk when instance is deleted.A€
...
Correct Answer: A
Reference:
https://googlecloudplatform.uservoice.com/forums/302595-compute-engine/ suggestions/14227521-set-delete-boot-disk-when-instance-is-
deleted-to
Community vote distribution
B (10
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 68/85

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #158 Topic 1
Your company uses a large number of Google Cloud services centralized in a single project. All teams have specific projects for testing and
development. The
...
C (100%)
Topic 1
You are building an application that processes data files uploaded from thousands of suppliers. Your primary goals for the application are data
...
Community vote distribution
AB (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 69/85
...
Community vote distribution
B (94%) 6%
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 70/85
...
A. Grant the financial team the |AM role of A€Billing Account Usera€ on the billing account linked to your credit card.
...
specific percentage of your production users (canary deployment). What should you do?
A. Create a new service with the new version oft he application. Split traffic between this version and the version that is currently running.
...
Community vote distribution
D (100
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 72/85
...
the Pub/Sub topic.
B. Deploy a Dataflow job from the batch template, A€Datastore to Cloud Storage.a€ Schedule the batch job on the desired interval.
...
Community vote distribution
A (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 73/85
...
C. Place the private key file in the installation directory of the Cloud SDK and rename it to A€credentials.jsona€.
D. Place the private key file in your home directory and rename it to A€GOOGLE_APPLICATION_CREDENTIALSA£.
Correct Answer: B
Reference:
...
You are monitoring an application and receive user feedback that a specific error is spiking. You notice that the error is caused by a Service
...
Community vote distribution
C (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 74185

10/9/22, 7:19 PM Associate Cloud Engineer Exam — Free Actual Q&As, Page 1| ExamTopics
Question #173
You are developing a financial trading application that will be used globally. Data is stored and queried using a relational structure, and clients
...
fast data access, and you need to configure the most appropriate resources on Google Cloud for this application. What should you do?
...
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 75185
...
You are creating an application that will run on Google Kubernetes Engine. You have identified MongoDB as the most suitable database system for
...
You are managing a project for the Business Intelligence (Bl) department in your company. A data pipeline ingests data into BigQuery via
streaming. You want the users in the Bl department to be able to run the custom SQL queries against the latest data in BigQuery. What should you
do?
A. Create a Data Studio dashboard that uses the related BigQuery tables as a source and give the Bl team view access to the Data Studio
dashboard.
B. Create a Service Account for the Bl team and distribute a new private key to each member of the Bl team.
C. Use Cloud Scheduler to schedule a batch Dataflow job to copy the data from BigQuery to the Bl team's internal data warehouse.
D. Assign the IAM role of BigQuery User to a Google Group that contains the members of the Bl team.
Correct Answer: C
Community vote distribution
D (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 76/85
...
only be accessible over the internal network. All servers need to be able to talk to each other over specific ports and protocols. The current on-
...
A. 1. Create a single VPC with a subnet for the DMZ and a subnet for the LAN. 2. Set up firewall rules to open up relevant traffic between the
DMZ and the LAN subnets, and another firewall rule to allow public ingress traffic for the DMZ.
B. 1. Create a single VPC with a subnet for the DMZ and a subnet for the LAN. 2. Set up firewall rules to open up relevant traffic between the
DMZ and the LAN subnets, and another firewall rule to allow public egress traffic for the DMZ.
C. 1. Create a VPC with a subnet for the DMZ and another VPC with a subnet for the LAN. 2. Set up firewall rules to open up relevant traffic
between the DMZ and the LAN subnets, and another firewall rule to allow public ingress traffic for the DMZ.
D. 1. Create a VPC with a subnet for the DMZ and another VPC with a subnet for the LAN. 2. Set up firewall rules to open up relevant traffic
...
D. Grant yourselthfe IAM role of Cloud Spanner Admin.
Correct Answer: B
Reference:
https://cloud.google.com/spanner/docs/instances
Community vote distribution
A (71%) 14% 14%
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 77185
...
D. Grant yourselthfe IAM role of Computer Admin.
Correct Answer: D
Reference:
...
Community vote distribution
C (83%) A (17%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 78185
...
You need to configure optimal data storage for files stored in Cloud Storage for minimal cost. The files are used in a mission-critical analytics
...
Community vote distribution
D (53%) B (47%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 79/85
...
A. Deploy the application on App Engine. For each update, create a new version of the same service. Configure traffic splitting to send a small
percentage oft raffic to the new version.
B. Deploy the application on App Engine. For each update, create a new service. Configure traffic splitting to send a small percentage of traffic
to the new service.
C. Deploy the application on Kubernetes Engine. For a new release, update the deployment to use the new version.
D. Deploy the application on Kubernetes Engine. For a new release, create a new deployment for the new version. Update the service to use the
new deployment.
Correct Answer: B
Reference:
...
Google's recommended practices and avoid conflicting accounts. What should you do?
...
Community vote distribution
A(9
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 80/85
...
Community vote distribution
B (56%) C (44%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 81/85
...
Community vote distribution
B (64%) C (27%) 9%
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 82/85
...
You have been asked to set up the billing configuration for a new Google Cloud customer. Your customer wants to group resources that share
...
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 83/85
...
optimized for n1-standard machine types. You need to optimize your cluster so that all workloads are using resources as efficiently as possible.
What should you do?
...
D. Configure the required amount of CPU and memory in the resource requests specification of the image rendering microservice deployment.
Keep the resource requests for the other microservices at the default.
Correct Answer: B
Community vote distribution
B (100%)
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 84/85
...
Community vote distribution
A(oU%, B (9U%,
https:/Mww.examtopics.com/exams/google/associate-cloud-engineer/custom-view/ 85/85